...
---@class TraceReportParams
---@field request_url fun(url: string, body: string, callback: fun(result: any), options: table)
---@field get_player_info fun(player): table
---@field json_encode fun(data: table): string
---@field is_editor_mode? fun(): boolean
---@field cooldown_seconds? number

--- Create reporter
---@param params TraceReportParams
---@return table
